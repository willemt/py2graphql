...
class Query(object):
    ...
    """
    def __init__(self, operation_type='query', client=None, parent=None,
                 operation_name=None, operation_variables=[]):
        ...
        if nodes:
            ...
            if self._operation_name:
                operation = ' {name}({variables})'.format(
                    ...
                    variables=','.join('{}: {}'.format(k, v)
                                       for k, v in self._operation_variables),
                )
            else:
                operation = ''
